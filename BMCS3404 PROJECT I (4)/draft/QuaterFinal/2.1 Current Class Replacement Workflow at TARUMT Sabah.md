# **2.1 Current Class Replacement Workflow at TARUMT Sabah**

**2.1.1 TARCApp — View-Only Timetable System (All TARUMT Branches)**
...
**2.1.2 Google Sheets — Manual Replacement Coordination (Sabah FOCS)**
...
| Capability | TARCApp | Google Sheets | Proposed System |
| :---- | :---- | :---- | :---- |
...
| Audit trail | ✅ Final only | ❌ | ✅ Full history |
| Role-based access | ✅ (auth only) | ❌ | ✅ Student/Lecturer/PL |
| Real-time slot search | ❌ | ❌ | ✅ Cross-cohort matrix intersection |
