Create a single interactive HTML file at `lect/mad html/chapter1_1_interactive.html` that turns Chapter 1.1 of the BMIT2073 lecture notes into a study tool. Use the same dark theme as `chapter1_intro.html` (read it first for exact CSS variables, fonts, class names, and layout patterns).
...
- **All answers must come from the lecture PDF source material** — read `Chapter 1 Merged.pdf`, `Chapter 1 .1 Introduction to Mobile Application Development.pdf` to extract exact content
